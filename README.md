...
Если вы хотите, чтобы логотип проекта отображался в верхнем левом углу диаграммы, добавьте файл logo.png в корень проекта
Если вы хотите, чтобы логотип проекта отображался в левом верхнем углу диаграммы, добавьте путь к файлу к параметру логотипа в конфигурации.
 
  
Заполнить необходимые опции в базовом блоке (пожалуйста, будьте осторожны, поле языка обязательно!)
...
Чтобы указать дополнительную конфигурацию прокси в блоке прокси.
